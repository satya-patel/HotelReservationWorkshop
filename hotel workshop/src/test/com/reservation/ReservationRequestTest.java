...
public class ReservationRequestTest {
    ...
    public void shouldHaveDayTypeWeekday() {
        ReservationRequest request = new ReservationRequest("Regular: 20Mar2020(fri)");
        assertThat(request.getRateType(), is(RateType.Weekday));
    }

    @Test
    public void shouldHaveDayTypeWeekend() {
        ReservationRequest request = new ReservationRequest("Regular: 21Mar2020(sat)");
    ...
    public void shouldHaveCustomerTypeRewards() {
        ReservationRequest request = new ReservationRequest("Rewards: 20Mar2020(fri)");
    ...
    public void shouldHaveMultipleRateTypesPerRequestWhenRequestHasWeekdaysAndWeekendDays(){
        ReservationRequest request = new ReservationRequest("Rewards: 20Mar2020(fri) 21Mar2020(sat)");
        List<LocalDate> dates = newArrayList(new LocalDate(2020, 3, 20), new LocalDate(2020, 3, 21));
