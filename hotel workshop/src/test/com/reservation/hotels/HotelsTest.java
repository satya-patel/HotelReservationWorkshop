...
public class HotelsTest {
    ...
    public void shouldFindBestRateForRegularWeekday() {
        ...
        assertThat(hotels.hotelWithBestRateFor(new ReservationRequest("Regular: 20Mar2020(fri)")), is("hotel name"));
    }
    ...
    public void shouldFindBestRateForRegularWeekdayWithTwoChoices() {
        ...
        assertThat(hotels.hotelWithBestRateFor(new ReservationRequest("Regular: 20Mar2020(fri)")), is("hotel name 2"));
    }
...
//        total 190
        ...
        assertThat(hotels.hotelWithBestRateFor(new ReservationRequest("Regular: 20Mar2020(fri) 21Mar2020(sat)")), is("hotel name 1"));
    }
}
